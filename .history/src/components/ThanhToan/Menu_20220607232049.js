...
function Menu(props) {
  ...
  if( id !== undefined){
    const [foodsChoose,setFoodsChoose]=useState(props.props[3][i]);
  }
  else{const [foodsChoose,setFoodsChoose]=useState([]);}
  ...
  return (
    ...
    <Order props={[foodsChoose,total,props.props[2],props.props[3]]} changeTotal={()=>{changeTotal()}}></Order>
    </>
  );
}
