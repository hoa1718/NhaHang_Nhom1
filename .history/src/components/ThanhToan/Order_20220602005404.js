          ...
          <div className="order-item">
            ...
            <span className="item-quantity">
              <button
                ...
                id="minus"
                onClick={(e) => {Decrease(e, foodsChoose[item].GiaBan, i);sumMoney()}}
              >
                -
              </button>
              <input
                onChange={(e) =>{
                  changQuantity(e,i, e.target.value, foodsChoose[item].GiaBan);
                  sumMoney();
                }  
                }
                className="quantity"
              ...
              <button
                className="change-quantity"
                id="plus"
                onClick={(e) => {Increment(e, foodsChoose[item].GiaBan, i);sumMoney()}}
              >
                +
              </button>
            </span>
