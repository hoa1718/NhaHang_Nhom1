...
function Order(props) {
  ...
  const changQuantity = (e,GiaBan) =>{
    ...
    total.innerText=changeMoneyFormat(Number(number)*Number(GiaBan));
    ...
    return (
      ...
      <div className="order-item">
        ...
        <span className="item-quantity">
          ...
          <input onChange={e => changQuantity(e,foodsChoose[item].GiaBan)} className="quantity" type="text" name="quantity" min={1} defaultValue={1} />
