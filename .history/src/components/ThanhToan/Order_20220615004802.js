    ...
    <div className="col-lg-5">
      <div className="order-wrapper">
        ...
        <div className="addinfor">
          ...
          <span style={{paddingLeft:"2px",color:"green",overflow:"hidden"}} id="sa"></span>
          <input type="text" id="cardId" onChange={(e)=> {setVoucher(e.target.value);console.log(customer)}}></input>
          <button>
            <i className="fa-solid fa-magnifying-glass"></i>
          </button>
        </div>
