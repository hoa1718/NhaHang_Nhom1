    ...
    <li key={foodsChoose[item].IDMon} className="order-li">
      <div className="order-item">
        ...
        <span className="item-quantity">
          <button className="change-quantity" id="minus" onClick={e => Decrease(e,foodsChoose[item].GiaBan,i)}>-</button>
          ...
          <button className="change-quantity" id="plus" onClick={e => Increment(e,foodsChoose[item].GiaBan,i)}>+</button>
        </span>
 ...
 useEffect(()=>{
  ...
  <div className="order-wrapper">
    ...
    <div className="purchase">
      ...
      <span id="total">{changeMoneyFormat(props.props[1])}</span>
