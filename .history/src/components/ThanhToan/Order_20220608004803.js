...
function Order({ props, changeTotal }) {
  ...
  const deleteOrder = (id) =>{
    axios
    .post("http://localhost:4000/ThanhToan/Delete/"+id)
    .then((res) => {
      window.location.reload();
      alert(res);
    })
  ...
  const saveOrder= (e)=>{
    ...
    axios
      .ge("http://localhost:4000/ThanhToan/Save", formData, config)
      .then((res) => {
    ...
    <div className="col-lg-5">
      <div className="order-wrapper">
        {id  ? 
          <div className="desk">
            ...
            <span className="btn-deleteBill">
              ...
              <input type={"button"} onClick={(e)=>deleteOrder(id)} value="Hủy"></input>
            </span>
          </div>
         : 
          <div className="desk">
            ...
            <span>
              ...
              <input type={"button"} value="Hủy"></input>
            </span>
          </div>
        }
        ...
        <div className="purchase">
          ...
          <input type={"button"} onClick={e=> saveOrder(e)} className="btn-purchase" id="save" value={"LƯU"}>
