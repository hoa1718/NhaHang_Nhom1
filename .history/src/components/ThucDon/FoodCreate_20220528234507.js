...
function FoodCreate({ open, close }) {
  ...
  const clearNode = (e) =>{
    ...
    // var targetElem = e.target.parentElement.parentElement; 
    // targetElem.remove();
  }
  useEffect(()=>getNguyenLieu(),clearNode(getlastID(),[]);
  if (!open) return null;
        ...
        <div className="form-create">
          ...
          <div className="wrap-input" id="CongThuc">
            ...
            <div id="NguyenLieu" style={{marginLeft:"-20px"}}>
              ...
              <div className="wrap-input">
                <button className="btn-clear" onClick={(e)=> clearNode(e)}>X</button>
              </div>
            </div>
          </div>
