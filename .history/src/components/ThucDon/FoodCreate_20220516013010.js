...
function FoodCreate({ open, close }) {
  ...
  const createFood = (event.preventDefault();) =>{
    let food ={
      TenMon:TenMon,
      GiaBan:GiaBan,
      GiaTien:GiaTien,
    ...
    axios.post('http://localhost:4000/ThucDon/Create',{food}).then(res =>{
      console.log(res);
    })
  }
  if (!open) return null;
    ...
    <div>
      <div className="overlay">
        <div className="form-create">
          ...
          <form method="post" onSubmit={createFood()}><div className="wrap-input">
