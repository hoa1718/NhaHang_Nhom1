...
const search =(e,keyword)=>{
  e.preventDefault();
  axios.get('http://localhost:4000/ThucDon/Search/'+keyword)
  .then(res=>{
        ...
        return(
                    <tr>
                      ...
                      <td>
                        ...
                        <button
                          className="btn-func"
                          onClick={() => {handleShow();setID(foods[item].IDMon);}}
                          style={{
                            outline: "none",
                            border: "none",
                            background: "none",
        ...
        <form className="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search search-form"
              ...
              <div className="input-group">
                ...
                <div className="input-group-append">
                  <button className="btn btn-primary" onClick={(e)=>{search(e,keyword)}} type="button">
