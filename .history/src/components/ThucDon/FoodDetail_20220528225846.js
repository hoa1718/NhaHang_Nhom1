...
function FoodDetail({ open, close,props }) {
  ...
  <div classname="wrap-input">
    ...
    <input type="{&quot;text&quot;}" name="NguyenLieu" classname="create-input" placeholder="Nguyên liệu..." />
  </div>
  <div classname="wrap-input">
    <p htmlfor="SoLuong" classname="create-label">
      Số lượng
    </p>
    <input type="{&quot;text&quot;}" name="Số lượng" classname="create-input" placeholder="Số lượng..." />
  </div>
</div>
      ...
      <div className="overlay">
        <div className="form-create">
          ...
          <div className="wrap-input" style={{ margin: "10px 0" }}>
            ...
            <img src={props[0].Image} alt="Food" style={{width:"200px",height:"200px"}}></img>
          </div>
