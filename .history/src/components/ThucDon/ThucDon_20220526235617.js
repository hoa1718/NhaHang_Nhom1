  ...
  const search = (e, keyword) => {
    ...
    axios
      ...
      .then((res) => {
        ...
        var temp= displayFoods(foods);
        console.log(temp);
        result.current.innerHTML=" <tr><th>Mã Món</th><th>Tên Món</th><th>Phân Loại</th><th>Hình Ảnh</th><th>Giá Tiền</th><th className=\"btn-wrapper\" /></tr>" +
         ReactDOMServer.renderToStaticMarkup(displayFoods(foods));
      })
      .catch((err) => {
        console.log(err);
      });
