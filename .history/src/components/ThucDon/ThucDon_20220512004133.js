...
function ThucDon(props) {
  ...
  Gà rán
  Món chính
  <img 70 style={{}} width: 70, height: }} alt="food" src="https://mcdonalds.vn/uploads/2018/2-ga-ran.png" />
  20000
  <button classname="btn-func" onclick="{()" => {'{'}
    ...
    <button classname="btn-func" onclick="{()" => {'{'}
      ...
      |
      <button classname="btn-func" style={{}} outline: "none", border: background: }}>
  ...
  return (
    <>
      ...
      <h2 style={{  marginLeft: "25px" }}>
        {Object.keys(foods).map((item,i)=>{
          return <h2 > {foods[item].TenMon}</h2>
        })} 
      </h2>
      : <h1>Not load</h1>}
