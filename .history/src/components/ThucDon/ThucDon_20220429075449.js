...
import ModalDetail from "../ModalCreate/ModalDetail";
      ...
      <div className="container-fluid">
        <div className="card shadow mb-4">
          ...
          <button
            ...
            <ModalCreate open={isOpen} close={()=> setOpen(false)}></ModalCreate>
            <div className="table-responsive">
              ...
              >
                ...
                setOpen(true);
                        ...
                        <ModalDetail open={isOpen} close={()=> setOpen(false)}></ModalDetail>
                      </a>
                      |
                      <a className="btn-func" href=" ">
