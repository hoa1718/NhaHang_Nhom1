...
function HoaDon(props) {
  ...
  return (
      <><h2>Hoá đơn</h2>
       <div className='modal'>
          <div className='overlay'>ss</div>
      </div>
      <div className="container-fluid">
      <div className="card shadow mb-4">
        <div className="card-body">
        <button className='btn-create' onClick={()=>{setOpen(true);console.log("Hello")} }><i class="fa-solid fa-plus"></i>Tạo mới</button> 
      ...
      </div><Modal open={isOpen}>Hello</Modal>
