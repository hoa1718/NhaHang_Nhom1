    ...
    <tbody><tr>
      ...
      <tr>
        <td className="foods-item">
          <a href=" ">
            <img className="foods-item-img" src="https://mcdonalds.vn/uploads/2018/2-ga-ran.png" alt='' />
            <p className="foods-item-name">Gà rán</p>
          </a>
        </td>
        <td className="foods-item">
          <a href=" ">
            <img className="foods-item-img" src="https://mcdonalds.vn/uploads/2018/2-ga-ran.png" />
            <p className="foods-item-name">Gà rán</p>
          </a>
        </td>
        <td className="foods-item">
