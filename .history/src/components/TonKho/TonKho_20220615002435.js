...
function TonKho(props) {
  ...
  return (
    <>
    {cookie.role=="admin" ?  <div style={{ position: "relative", marginBottom: "20px" }}>
      ...
      <Nhap id={idCurrent} open={isOpenImport} close={() => { setOpenImport(false); fetchNguyenLieu() }}></Nhap>:<h1></h1>}
